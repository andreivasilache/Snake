...
var textSize=1.3;   	//controlls the page size (1.3 normal value)
var width=1500;		 //width of the page default 1500
var heigth=700; 	//heigth of the page default 700
var gameSpeed=80;  //controlls the speed of the snake
...
function checkSelfCollision(){ //check if snake hitted himself
...
function checkApple(){ // check all the neighbors of Apple,becouse math.random makes values %!=0 to snake coordonates.
